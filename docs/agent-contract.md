...
The agent **does not autonomously act**, **does not chain tools**, and **does not hallucinate answers**.
...
2. **Tool-Grounded Responses**
   - All factual outputs must originate from MCP tools
